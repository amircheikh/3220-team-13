  ...
  const handleReset = () => {
    setFilterSettings({
      ...
      data: {
        ...
        pedwalkspeed: '',
        aps_operation: '',
        numberofapproaches: null,
        objectid: null,
        geo_id: null,
        node_id: null,
        audiblepedsignal: false,
        transit_preempt: false,
        fire_preempt: false,
        rail_preempt: false,
        mi_prinx: null,
        bicycle_signal: false,
        ups: false,
        led_blankout_sign: false,
        lpi_north_implementation_date: null,
        lpi_south_implementation_date: null,
        lpi_east_implementation_date: null,
        lpi_west_implementation_date: null,
        lpi_comment: '',
        coordinates: '',
